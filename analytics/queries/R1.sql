-- Статьи: просмотры и вовлечённость
-- Когорта по времени pageview, события engagement связаны тем же view_id. Повторный engagement в одном просмотре не увеличивает числитель.
SELECT
  slug AS article,
  count() AS viewed,
